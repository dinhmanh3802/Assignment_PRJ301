...
public class creategenealogy extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        gd.insert(request.getParameter("genealogytitle"));
        Genealogy ge = gd.getGenealogyByGenealogytitle(request.getParameter("genealogytitle"));
        response.sendRedirect("updategenealogy?id=" + ge.getID());
    }
