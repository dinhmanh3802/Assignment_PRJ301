                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    ...
                                    <h3>Fullname:</h3><div class="form-outline mb-4">
                                        <input type="text" id="form6Example0" class="form-control"  readonly/>
                                        
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col">
                                            <h3>Date of birth:</h3><div class="form-outline">
                                                <input type="date" id="form6Example1" class="form-control" readonly/>
                                                
                                            </div>
                                        </div>
                                        <div class="col">
                                            <h3>Date of death:</h3><div class="form-outline">
                                                <input type="date" id="form6Example2" class="form-control" readonly/>
                                    ...
                                    <h3>Occupation:</h3><div class="form-outline mb-4">
                                        <input type="text" id="form6Example3" class="form-control" readonly/>
                                        
                                    </div>

                                    <!-- Text input -->
                                    <h3>Address:</h3><div class="form-outline mb-4">
                                        <input type="text" id="form6Example4" class="form-control" readonly/>
                                    ...
                                    <h3>Phone number:</h3><div class="form-outline mb-4">
                                        <input type="number" id="form6Example6" class="form-control" readonly/>
                                    
                                    </div>

                                    <!-- Message input -->
                                    <h3>Description:</h3><div class="form-outline mb-4">
                                        <textarea class="form-control" id="form6Example7" rows="4"readonly></textarea>
