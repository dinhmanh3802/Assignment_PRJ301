                                        ...
                                        <form class="mx-1 mx-md-4">
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <input type="text" class="form-control" readonly value="<%= (String)session.getAttribute("username") %>" />
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                <i class="fas fa-lock fa-lg me-3 fa-fw"></i>
                                                <div class="form-outline flex-fill mb-0">
                                                    <input type="text"  class="form-control" readonly value="<%= (String)session.getAttribute("emailaddress") %>" />
                                                    <label class="form-label" for="form3Example4c">Your Email Address:</label>
                                                </div>
                                            </div>

                                            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                                <a type="button" href="homepage.jsp" class="btn btn-primary btn-lg">HOME</a>
